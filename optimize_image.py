...
def main():
    try:
        ...
        parser = argparse.ArgumentParser(
            description='Script to find, with or without regularization, images that cause high or low activations of specific neurons in a network via numerical optimization. Settings are read from settings.py, overridden in settings_MODEL.py and settings_user.py, and may be further overridden on the command line.',
        ...
        # Where to start
        parser.add_argument('--start-at', type=str, default='mean_plus_rand',
        ...
        parser.add_argument('--lr-policy', type=str, default=settings.optimize_image_lr_policy,
        ...
        parser.add_argument('--brave', action='store_true', default=True,
                            help='Allow overwriting existing results files. Default: off, i.e. cowardly refuse to overwrite existing files.')
        parser.add_argument('--skipbig', action='store_true', default=True,
